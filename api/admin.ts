...
export async function GetUsers(
  ...
  AxiosResponse<IAPIResponseGetUsers, any> | AxiosError<IAPIErrorResponse, any>
> {
  return axios
...
export async function GetUser(
  ...
  AxiosResponse<IAPIResponseGetUser, any> | AxiosError<IAPIErrorResponse, any>
> {
  return axios
...
export async function CreateUser(
  ...
  | AxiosResponse<IAPIResponseCreateUser, any>
  | AxiosError<IAPIErrorResponse, any>
> {
  return axios
...
export async function UpdateUser(
  ...
  | AxiosResponse<IAPIResponseUpdateUser, any>
  | AxiosError<IAPIErrorResponse, any>
> {
  return axios
...
export async function DeleteUser(
  ...
  | AxiosResponse<IAPIResponseDeleteUser, any>
  | AxiosError<IAPIErrorResponse, any>
> {
  return axios
...
export async function GetPaidLeaves(
  ...
  | AxiosResponse<IAPIResponseGetPaidLeavesWithUser, any>
  | AxiosError<IAPIErrorResponse, any>
> {
  return axios
    ...
    .then(
      async (
        response: AxiosResponse<IAPIResponseGetPaidLeavesWithUser, any>,
      ) => {
        await storage.save({
          key: "paidLeaves",
...
export async function UpdateIPAddresses(
  ...
  | AxiosResponse<IAPIResponseUpdateCompany, any>
  | AxiosError<IAPIErrorResponse, any>
> {
  return axios
    .patch(
