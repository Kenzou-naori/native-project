...
export default function HomeScreen() {
  ...
  return (
    <View className="mt-6 bg-[#DEE9FD] h-full">
	  ...
	  <View className="p-5">
        <View
          className=" rounded-[60px] px-5 py-14 "
          // style={styles.shadow}
        >
          <View className="flex flex-col gap-8 justify-center">
            ...
            <View className="bg-[#cedfff] rounded-[50px] shadow shadow-gray-800 px-4 py-6">
              ...
              <View className="flex-row pt-4 justify-around">
                ...
                >
                  <Text className="text-white text-lg font-semibold px-5">Sakit</Text>
                </Pressable>
                <Pressable
                  className={
                    day === "Sabtu" || day === "Minggu"
                ...
                >
                  <Text className="text-white text-lg font-semibold px-5">Cuti</Text>
                </Pressable>
              </View>
            </View>
          </View>
