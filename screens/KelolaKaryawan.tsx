...
const WebAdmin = () => {
  ...
  function renderDropdown(){
    if (visible) {
      return (
        <View className="absolute top-10 float-right bg-white flex-col rounded-lg shadow-lg w-48" style={{ elevation:999, zIndex:999}} >
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
              ...
              >
                <View className="bg-[#DEE9FD] rounded-full mt-6">
                  <Text className="py-2 px-3 text-xl font-semibold text-center text-gray-600">
                    Tambah
                  </Text>
                </View>
              </TouchableOpacity>
